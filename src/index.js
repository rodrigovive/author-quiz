...
const state = {
  turnData: {
    ...
    books: getTurnData(authors).books,
  },
  highlight: '',
};
...
//   return React.createElement('button', {onClick: props.click}, 'XD');

// }
// {click() { console.log('a'); }}
// ReactDOM.render(React.createElement('label', null,'ASD',React.createElement(button,{click() { console.log('a'); }}),'qwe'),
//     document.getElementById('root'));
